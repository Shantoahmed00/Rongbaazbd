...
def login():
	...
	print "\033[1;91m[1]\033[1;95mLogin With Facebook"
        ...
        time.sleep(0.05)
        print "\033[1;94m[4]\033[1;95mShanto Ahmed"
        time.sleep(0.05)
	print "\033[1;95m[5]\033[1;95mSend msg my fb I'd For any help"
        time.sleep(0.05)
...
def menu():
	...
	time.sleep(0.05)
	print "\033[1;94m[3]\033[1;34mRest/Update SHANTO TOOL"
	time.sleep(0.05)
...
def pilih_super():
	...
	if peak =="":
		...
		try:
			...
			print"\033[1;98m[+]\033[1;91mName\033[1;93m:\033[1;97m "+op["name"]
		except KeyError:
			print"\033[1;96m[+]\x1b[1;91mID Not Found!"
			raw_input("\n\033[1;96m[\033[1;98mBack\033[1;96m]")
			super()
		print"\033[1;98m[+]\033[1;94mIf you don't get any ID, turn on flight mode for 5 seconds"
	...
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;94m[+]\033[1;31mCloning  Has Been Started  Use 4G Internet\033[1;97m"+o),;sys.stdout.flush();time.sleep(0.05)
